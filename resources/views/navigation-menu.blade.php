    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('equipment-stocks.index') }}" :active="request()->routeIs('dashboard')">
                        {{ __('Estoque') }}
                    </x-jet-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('report.index') }}" :active="request()->routeIs('dashboard')">
                        {{ __('Relatorios') }}
                    </x-jet-nav-link>
                </div>
            </div>
